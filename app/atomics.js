...
(function (root) {
  ...
  function GalaxyWidgetRow() {
    var pillStyle =
      'width:138px;height:62px;background:rgba(23,23,26,0.3);' +
  ...
  var QS_TILE_BG = 'background:rgba(23,23,26,0.3);border:1px solid rgba(255,255,255,0.2);';
  var QS_TILE_RADIUS = 'border-radius:50px;';

  // 88×88 single toggle (plus-icon by default)
  function qsSingleToggle(iconHTML) {
    ...
    return '<div style="width:88px;height:88px;max-width:88px;max-height:88px;aspect-ratio:1/1;' +
             ...
             'display:flex;flex-direction:column;align-items:center;justify-content:center;padding:10px 0;overflow:hidden;flex:1 0 0;min-width:0;box-sizing:border-box;">' +
             iconHTML +
           '</div>';
  }

  // 199×88 half-width toggle card with title + subtitle
  function qsHalfToggle(iconHTML, title, subtitle) {
    return '<div style="width:199px;height:88px;max-height:88px;' +
             QS_TILE_BG + QS_TILE_RADIUS +
             'display:flex;flex-direction:column;justify-content:center;padding:24px 17px;overflow:hidden;flex:1 0 0;min-width:190px;box-sizing:border-box;">' +
             '<div style="display:flex;gap:10px;align-items:center;width:176px;">' +
               iconHTML +
               '<div style="flex:1 0 0;min-width:0;display:flex;flex-direction:column;overflow:hidden;">' +
                 '<p style="font-family:' + FONT_SEMI + ';font-weight:600;font-size:16px;line-height:normal;color:#EFEEF2;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' + title + '</p>' +
                 (subtitle ? '<p style="font-family:' + FONT_REGULAR + ';font-weight:400;font-size:14px;line-height:normal;color:#CFCCCF;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' + subtitle + '</p>' : '') +
               '</div>' +
             '</div>' +
           '</div>';
  }
  ...
  function GalaxyNotifScreen() {
    ...
    var liveNotif =
      '<div style="width:100%;height:86px;display:flex;gap:15px;align-items:center;padding:0 16px;border-radius:50px;overflow:hidden;flex-shrink:0;box-sizing:border-box;' +
    ...
    var aiRegular =
      '<div style="width:415px;height:86px;display:flex;gap:10px;align-items:center;padding:15px 20px 15px 16px;border-radius:50px;overflow:hidden;flex-shrink:0;box-sizing:border-box;' +
    ...
    var stackNotif =
      '<div style="width:415px;height:91px;display:flex;align-items:center;padding:15px 0;border-radius:50px;overflow:hidden;flex-shrink:0;box-sizing:border-box;">' +
        '<div style="flex:1 0 0;display:flex;flex-direction:column;align-items:center;border-radius:30px;overflow:hidden;">' +
          '<div style="width:100%;height:86px;display:flex;gap:10px;align-items:center;padding:15px 20px 15px 16px;background:rgba(23,23,26,0.3);border-radius:50px;overflow:hidden;box-sizing:border-box;">' +
            nfAvatar() +
            '<div style="flex:1 0 0;min-width:0;display:flex;flex-direction:column;overflow:hidden;">' +
